...
const Anecdote = ({text, votes}) => <div><p>{text}<br/>has {votes} votes</p></div>
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Button text = "next anecdote" handleClick = {() => handleClick(anecdotes.length)}/>
      <Header text = 'Anecdote with most votes' />
      <Anecdote text = {anecdotes[topVote]} votes = {points[selected]} />
